...
<div class="survey">
<div>
<div>Student ID <Strong><BLINK><span style="color:red ;text-decoration: blink"> ${sms}</span></BLINK></Strong></div>
...
<div>User Name</div>
         <div>     <input type = "text" id = "Name" name="name"
             ...
             <div>Address Street</div>
               <div><input type = "text" id = "AddressStreet" name="address"
       ...
       <p>        
      <div>  Tel</div>
            <div> <input type="text"  name="tel" placeholder = "(###) ###-####"
                      /> 
        ...
        <div>     Date of survey</div>
             <div>  <input type = "date" id = "date" name="dates"
                 placeholder = "yyy-mm-dd" /> </div><p>
            
             <div>   What did you like the most?</div>
             <div>   students
              <input name="like" type = "checkbox" id="student" 
...
<div> High school graduation month</div>
 <div>  <input list="gradMonths" name="graduationMonth"></div>
...
<div><select name="recommendation">
